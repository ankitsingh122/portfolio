    ...
    >
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between max-md:px-4 max-md:py-3" aria-label="Main navigation">
        <a
          ...
          title="Ankit Singh - Full Stack Engineer Portfolio Home"
        >
          Ankit Singh
        </a>
          ...
          <div className="px-4 py-6 space-y-1">
            ...
            <div className="pt-4 mt-4 border-t border-slate-200 dark:border-white/5 flex items-center gap-4">
              ...
              <div className="flex gap-2">
                <a href="https://www.linkedin.com/in/ankitsingh122/" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-teal-600 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://github.com/ankitsingh122" target="_blank" rel="noopener noreferrer" className="p-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-teal-600 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
                  <Github className="w-5 h-5" />
                </a>
                <a href="mailto:ankitsinghasingh007@gmail.com" className="p-2 rounded-lg text-slate-500 hover:bg-slate-100 hover:text-teal-600 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-white">
                  <Mail className="w-5 h-5" />
                </a>
              </div>
            </div>
